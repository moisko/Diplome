...
public class PresentationMarkupParserImplTest extends MathMLBaseTest {
	...
	@Test
	public void testParseMathFile_1_a() throws Exception {
		String pMathFileName = "mathFile_1_a.math";
		File pMathFile_1_a = new File(PRESENTATION_MARKUP_DIR, pMathFileName);
		
		// check expression equality
		IMathMLParser parser = new PresentationMarkupParser();
		  
		IMathMLExpression actualExpression = parser.parse(new FileInputStream(pMathFile_1_a));
		IMathMLExpression expectedExpression = new Expression(expectedExpression_1.getExpressionOperands());
...
//
//		List<PresentationMarkupElement> parsedMathMLElements = parser.parse(new FileInputStream(pMathFile_2));
//
...
//
//		boolean mfracElementInstance = parsedMathMLElements.get(0) instanceof MFracElement;
//
//		assertTrue(mfracElementInstance);
//
//		List<PresentationMarkupElement> mFracChildren = parsedMathMLElements.get(0).getChildren();
//
//		int actualMFracChildren = mFracChildren.size();
//
//		int expectedMFracChildren = 2;
//
//		assertEquals(expectedMFracChildren, actualMFracChildren);
//	}
//
//	@Test
